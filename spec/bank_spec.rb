...
RSpec.describe Bank do
  ...
  it "should printing correct bank statement format with one bank statement(transaction) " do
    bank = Bank.new
    bank.create_bank_statement(Time.new(2023, 1, 10),1000,nil, 1000)
  ...
  it "should printing correct bank statement format with three bank statement(transaction) " do
    bank = Bank.new
    bank.create_bank_statement(Time.new(2023, 1, 10),1000,nil, 1000)
    bank.create_bank_statement(Time.new(2023, 1, 13),2000,nil, 3000)
    bank.create_bank_statement(Time.new(2023, 1, 14),nil,500, 2500)
